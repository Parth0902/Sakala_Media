...
const Icon: React.FC<IconProps> = ({ img }) => {
  return (
    <div className="relative border-2 lg:border-4 border-[#1769FF] w-[42.095px] h-[42.095px] lg:w-[100px] lg:h-[100px] rounded-lg lg:rounded-3xl bg-white flex justify-center items-center transition duration-300 ease-in-out transform hover:scale-125 cursor-pointer">
