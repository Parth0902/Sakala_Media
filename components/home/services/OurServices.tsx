...
const HeaderSection: React.FC = () => {
  return (
    <section className="text-center pb-24">
      <h1 className="z-10 self-center mt-0 text-7xl font-bold text-white leading-[75px] max-md:max-w-full max-md:text-4xl max-md:leading-[49px]">
        Your Partners in Marketing &<br />
        Web Technology Solutions
      </h1>
      <p className="z-10 self-center mt-0 text-base leading-7 text-white max-md:max-w-full">
...
const OurServices: React.FC = () => {
  return (
    <main className="flex flex-col items-center px-24 py-40 main-container">
      <HeaderSection />
