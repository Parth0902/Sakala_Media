...
export default function FoundersMessage() {
  return (
    <div className="w-full relative">
      ...
      <section className="justify-center lg:px-24 py-20 flex flex-col items-center lg:flex-row lg:justify-center gap-32 ">
        ...
        <div className="w-full lg:max-w-3xl lg:w-2/3 space-y-6 text-center px-2">
